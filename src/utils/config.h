...
struct Config {
  ...
  inline static const size_t SNAKE_MIN_LEN = 0;
  inline static const size_t ERROR_MAX_LEN = 10;
  inline static const size_t GAP_MIN_DIFF = 10;
  ...
  inline static const size_t MINIMIZER_MIN_LEN = 70;
