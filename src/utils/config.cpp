...
const size_t Config::SNAKE_MIN_LEN = 5;
const size_t Config::GAP_MIN_DIFF = 3;
const size_t Config::GAP_MAX_DIFF = 50;
const size_t Config::DELTA_IGNORE_LEN = 2;
...
const size_t Config::MINIMIZER_MAX_DIFF = 2500;
const double Config::ERROR_MAX_SCORE = 5.0;
const double Config::MYERS_PENALTY = 0.4;
